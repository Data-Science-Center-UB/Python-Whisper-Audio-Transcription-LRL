...
/Notebooks (Jupyter notebooks for preprocessing audio files and conducting transcription, including speaker diarization and applications to low-resource languages (LRLs)) <br>
/Images (images loaded in the Jupyter notebooks) <br>
/Data_Raw (datasets downloaded and loaded in the Jupyter notebooks) <br>
/Data_Preprocessed (an intermediate audio file created in the faster-whisper-pyannote notebook, containing the input audio converted to a consistent format) <br>
/Models (fine-tuned Whisper model files automatically downloaded and converted by the faster-whisper-Swahili notebook for use with Faster-Whisper) <br>
/Results (exemplary transcription outputs generated by the notebooks) <br>
